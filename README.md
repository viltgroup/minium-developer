...
Minium has spawned from the work of Rui Figueira @VILT whose source code has dwealed into Minium Core. It combines jQuery and Selenium for purposes of browser testing and task automation.
