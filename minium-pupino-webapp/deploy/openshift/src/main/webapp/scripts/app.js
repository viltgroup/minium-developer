...
var pupinoApp = angular.module('pupinoApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
  'ngResource', 'ngRoute', 'ngCookies', 'pupinoAppUtils', 'pascalprecht.translate', 'truncate']);
