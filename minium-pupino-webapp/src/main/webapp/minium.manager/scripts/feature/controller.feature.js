...
miniumManager.controller('FeatureController', function($scope, $stateParams, $sce, $state,$modal, resolvedProject, Project, JenkinsProvider, BuildProject, BuildFacade) {
    ...
    $scope.openModalImage = function(imageSrc, imageDescription) {
        $modal.open({
            templateUrl: "/minium.manager/views/feature/modals/modalImage.html",
            resolve: {
