...
import minium.pupino.web.filter.CachingHttpHeadersFilter;
import minium.pupino.web.filter.StaticResourcesProductionFilter;
import minium.pupino.web.filter.gzip.GZipServletFilter;
import minium.pupino.web.method.support.AntPathHandlerMethodArgumentResolver;
import minium.pupino.web.method.support.BaseURLHandlerMethodArgumentResolver;
