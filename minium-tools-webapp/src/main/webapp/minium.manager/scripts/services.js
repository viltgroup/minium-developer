...
/* Services */
miniumManager.factory('Register', function($resource) {
    return $resource('app/rest/register', {}, {});
});

miniumManager.factory('Activate', function($resource) {
...
miniumManager.factory('Account', function($resource) {
    return $resource('app/rest/account', {}, {});
});

miniumManager.factory('Password', function($resource) {
    return $resource('app/rest/account/change_password', {}, {});
});

miniumManager.factory('Sessions', function($resource) {
...
miniumManager.factory('MetricsService', function($http) {
    return {
        get: function() {
...
miniumManager.factory('ThreadDumpService', function($http) {
    return {
        dump: function() {
...
miniumManager.factory('HealthCheckService', function($rootScope, $http) {
    return {
        check: function() {
...
miniumManager.factory('LogsService', function($resource) {
...
miniumManager.factory('AuditsService', function($http) {
    return {
        findAll: function() {
...
miniumManager.factory('Session', function() {
...
miniumManager.factory('AuthenticationSharedService', function($rootScope, $http, authService, Session, Account) {
    return {
...
miniumManager.factory('JenkinsProvider', ['$resource', '$http', function($resource, $http) {
    return {
...
miniumManager.factory('JenkinsProvider1', function($resource, $http) {
    return {
...
miniumManager.factory('BuildsFacade', function($rootScope) {
    /**
     * Constructor
     */
...
miniumManager.factory('BuildFacade', function() {
    /**
     * Constructor
     */
